...
export const getClassAndSkills = (userId) => {
  const selectClassAndSkills =
    `SELECT idClass, className, classPv, classDesc, JSON_ARRAYAGG(JSON_OBJECT('idSkills', skills.idSkills, 'skillsName', skills.skillsName, 'skillsDesc', skills.skillsDesc, 'abilityName', ability.abilityName)) AS skills  
    FROM class
