...
export const getWeapon = (userId) => {
    const selectWeapon = 
    'SELECT idWeapon, weaponName, weaponType, weaponDesc, weaponEffects, weaponRange, genreId, genreName FROM weapon INNER JOIN genre on genre.idGenre = weapon.genreId WHERE userId = ?;';
